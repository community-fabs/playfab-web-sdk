...
export interface CreateOrUpdateFacebookInstantGamesRequest
...
export interface CreateOrUpdateFacebookInstantGamesResponse
...
export interface CreateOrUpdateKongregateResponse
  extends IPlayFabResultCommon {}
...
export interface DeleteFacebookInstantGamesRequest
  extends IPlayFabRequestCommon {
  /** The optional custom tags associated with the request (e.g. build number, external trace identifiers, etc.). */
  CustomTags?: { [key: string]: string | null };
  /** The optional entity to perform this action on. Defaults to the currently logged in entity. */
...
export interface DeleteFacebookInstantGamesResponse
  extends IPlayFabResultCommon {}
